<%@ WebService Language="C#" Class="Slideshow_Save" %>
...
[ScriptService()]
public class Slideshow_Save : System.Web.Services.WebService
{
    ...
    [WebMethod()]
    public string Update(int itemid, string Title, string Description, string Order, bool Hide)
    {   
        string returnval = "";
        ConnString.Open();
        SqlCommand WETCommand = new SqlCommand();
